...
type User struct {
	...
	IsUpgrade    bool              `json:"is_upgrade" bson:"is_upgrade"`
...
type UserMail struct {
	...
	FirstNameTH string             `json:"firstname_th" bson:"firstname_th"`
	LastNameTH  string             `json:"lastname_th" bson:"lastname_th"`
	Password    string             `json:"password" bson:"password" binding:"required,min=8,max=255"`
	Phone       string             `json:"phone" bson:"phone"`
	Avatar      string             `json:"avatar" bson:"avatar"`
...
// UserBusiness owner event
type UserBusiness struct {
	UserID    primitive.ObjectID `json:"user_id" bson:"_id,omitempty"`
	Email     string             `json:"email" bson:"email" binding:"exists,email"`
	FullName  string             `json:"fullname" bson:"fullname"`
	CorporateName  string         `json:"corporatename" bson:"corporatename"`
	FirstName string             `json:"firstname" bson:"firstname"`
	LastName  string             `json:"lastname" bson:"lastname"`
	Phone     string             `json:"phone" bson:"phone"`
	Avatar    string             `json:"avatar" bson:"avatar"`
